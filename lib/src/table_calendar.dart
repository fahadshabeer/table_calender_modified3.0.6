...
typedef MyDateTimeCallback=void Function(HijriCalendar hijriDate);
...
class TableCalendar<T> extends StatefulWidget {
  ...
  final MyDateTimeCallback onDayTapped;
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget content =InkWell(
          onTap:(){
            widget.onDayTapped(HijriCalendar.fromDate(day));
          },
          child: CellContent(
